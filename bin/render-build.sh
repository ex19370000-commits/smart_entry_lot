...
bundle exec rails runner "Admin.find_or_create_by!(email: 'reviewer@smart-entry-lot.com') { |a| a.password = 'password'; a.password_confirmation = 'password'; a.display_name = '検証用管理者ユーザー' }"